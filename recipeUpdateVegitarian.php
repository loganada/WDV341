...
if (mysqli_connect_errno())
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
    ...
    $recipe_id = $_POST['recipe_ID'];
		...
		$sql = "UPDATE recipes_vegitarian SET " ;
		$sql .= "name_recipe=?, ";
		$sql .= "serving_size=?, ";
		$sql .= "prep_time=?, ";
		$sql .= "cook_time=?, ";
	...
	else
	{
		...
		$sql = "SELECT recipe_ID, name_recipe, serving_size, prep_time, cook_time, ingredients, prep_instruct, img FROM recipes_vegitarian WHERE recipe_ID=?";
...
?>
<form id="eventsForm" name="recipeForm" method="post" action="recipeUpdateVegitarian.php" enctype="multipart/form-data">
