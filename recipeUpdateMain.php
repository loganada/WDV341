...
if (mysqli_connect_errno())
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
	...
	else
	{
		...
		$sql = "SELECT recipe_ID, name_recipe, serving_size, prep_time, cook_time, ingredients, prep_instruct, img FROM recipes_main WHERE recipe_ID=?";
...
?>
<form id="eventsForm" name="recipeForm" method="post" action="recipeUpdateMain.php" enctype="multipart/form-data">
